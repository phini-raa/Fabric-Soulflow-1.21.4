...
public class AlchemyTableScreenHandler extends ScreenHandler {
    ...
    public AlchemyTableScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.addSlot(new Slot(inventory, 1, 53, 34) {
        ...
        this.addSlot(new Slot(inventory, 3, 121, 34) {
                    public boolean canInsert(ItemStack stack) {
                        return false;
                    }
    ...
    public ItemStack quickMove(PlayerEntity player, int invSlot) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (invSlot < this.inventory.size()) {
                ...
                if (originalStack.isOf(ModItems.HOLLOW_TOTEM)) {
                    if (!this.insertItem(originalStack, 1, 2, false)) return ItemStack.EMPTY;
                }
                else if (originalStack.isOf(ModItems.SOUL)) {
